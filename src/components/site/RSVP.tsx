    ...
    <section id="rsvp" className="py-24 md:py-32 border-t hairline">
      <div className="container-x">
        <div className="grid md:grid-cols-12 gap-10 items-start">
          <FadeIn delay={0.1} className="md:col-span-5">
            ...
            <p className="mt-5 text-sm text-[var(--deep)]/65 max-w-md">
              ...
              <a
                ...
                className="text-[var(--deep)] underline underline-offset-4 decoration-[var(--mist)] hover:decoration-[var(--deep)] transition-colors"
              >
                {site.rsvp.contact}
              </a>
            </p>
          ...
          <FadeIn delay={0.3} direction="up" className="md:col-span-7">
            <form
              onSubmit={submit}
              className="rounded-3xl border hairline bg-background p-6 md:p-8 hover:shadow-[0_20px_40px_rgba(0,0,0,0.04)] transition-shadow duration-500"
            >
              {done ? (
                ...
                <div className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-full bg-[var(--deep)] text-[var(--frost)] px-6 py-3.5 text-sm font-medium transition-transform duration-200 hover:scale-[1.02] hover:shadow-lg"
                  >
