  ...
  return (
    <section className="py-24 md:py-32">
      <div className="container-x">
        <FadeIn delay={0.1} className="max-w-3xl mb-14">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {site.packages.map((p, i) => (
            <FadeIn key={p.name} delay={0.2 + (i * 0.2)} direction={i % 2 === 0 ? "right" : "left"}>
              <div
                className={[
                  "rounded-3xl p-8 md:p-10 border hairline transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)]",
                  p.featured
                    ? "bg-[var(--deep)] text-[var(--frost)] border-transparent shadow-[0_10px_30px_rgba(27,38,44,0.15)]"
